...
export const FPS = 30;
export const TOTAL_DURATION_FRAMES = 1220;

// Act durations (in frames) — 7-act structure
export const ACT_1 = 160; // The Hook
...
export const ACT_6 = 320; // Excalidraw Magic (extended for full diagram draw)
export const ACT_7 = 100; // CTA Closing

export const TRANSITION_DURATION = 10;

// Composition dimensions
export const COMP_WIDTH = 960;
export const COMP_HEIGHT = 540;
